document.addEventListener('DOMContentLoaded', function(event) {
	...
	var images = [
		'/images/mockups/ar-aplikacija-dev-002.jpg',
		'/images/mockups/fin-unsa-ba.jpg',
		'/images/mockups/xliff-mockup.jpg'
	];
	const header = [ 'Popup header 1', 'Popup header 2', 'Popup header 3' ];
	const description = [ 'Popup description 1', 'Popup description 2', 'Popup description 3' ];
		...
		if (par == 'next') {
			...
			if (imgOne > images.length - 1 && imgTwo > images.length - 1) {
				...
				if (window.innerWidth > 768) {
					...
					currentPair = Math.floor(images.length - 1);
				}
		...
		if (par == 'previous') {
			...
			if (imgOne < 0 && imgTwo < 0) {
				...
				if (window.innerWidth > 768) {
					...
					currentPair--;
					console.log(imgOne, imgTwo, currentPair);
				}
			} else if (imgOne < 0) {
				imgOne = images.length - 1;
				imgTwo = 0;
