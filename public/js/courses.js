document.addEventListener('DOMContentLoaded', function(event) {
	...
	const images = [
		'/images/mockups/projects/project09.jpg',
		'/images/mockups/projects/project12.jpg',
		'/images/mockups/projects/project01.jpg',
		'/images/mockups/projects/project03.jpg',
		'/images/mockups/projects/project14.jpg',
		'/images/mockups/projects/project04.jpg',
		'/images/mockups/projects/project06.jpg',
		'/images/mockups/projects/project10.jpg',
		'/images/mockups/projects/project17.jpg',
		'/images/mockups/projects/project13.jpg',
		'/images/mockups/projects/project15.jpg',
		'/images/mockups/projects/project16.jpg'
	];
	const header = [
		'Popup header 1',
		'Popup header 2',
	...
	function popupContent(imgIndex, side) {
		...
		if (/*window.innerWidth < 768*/ notDisabled) {
			console.log(window.location.origin + courses[imgIndex]);
			window.localStorage.setItem('imagePath', courses[imgIndex]);
