...
<section class="section-one">
    ...
    <div class="section-one-img-container">
        ...
        <img class="section-one-img-right" src="{{ asset('images/careers/moodleAdministrator-page-img.svg') }}" />
    </div>
...
<section class="jobParameters contain">
    ...
    <h1 class="h1-font" id="availablePositions">@lang('careers-moodle.Dev-h1')</h1>

    <br /><br />

    <p class="p-font">@lang('careers-moodle.opisDev')</p>

    <br /><br />

    <h5 class="h5-font">@lang('careers-moodle.opis-poslova')</h5>
    <ul class="p-font">
        <li>@lang('careers-moodle.opis1')</li>
        <li>@lang('careers-moodle.opis2')</li>
        <li>@lang('careers-moodle.opis3')</li>
        <li>@lang('careers-moodle.opis4')</li>
        <li>@lang('careers-moodle.opis5')</li>
        <li>@lang('careers-moodle.opis6')</li>
    </ul>

    <br /><br />

    <h5 class="h5-font">@lang('careers-moodle.strucne-karakteristike')</h5>
    <ul class="p-font">
        <li>@lang('careers-moodle.karakteristika1')</li>
        <li>@lang('careers-moodle.karakteristika2')</li>
        <li>@lang('careers-moodle.karakteristika3')</li>
