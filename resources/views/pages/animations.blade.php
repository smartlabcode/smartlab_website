...
<div class="section1 contain">
    ...
    <div class="section1-1">
        ...
        <ul style="margin-left: 15px; font-size: 1.2em;" class="p-font bold">
            <li class="uls"> @lang('animations.secOneUlFirst')</li>
            <li class="uls">@lang('animations.secOneUlSecond')</li>
            <li class="uls">@lang('animations.secOneUlThird')</li>
            <li class="uls">@lang('animations.secOneUlFourth')</li>
        </ul>
    </div>
...
<div class="section3 contain" >
    <div style="height: 50%">
        <h5 class="sec3text">@lang('animations.sec2h22')</h5>
    </div>
    <div style="height: 50%; margin-top: 5%; display: flex; justify-content: center">
        <button id="button" class="button">@lang('animations.buttonSchedule')</button>
    </div><br>
</div><br>
    ...
    <div class="contact-form-container">
        <form class="contact-form">
            ...
            <div class="contact-form-group">
                ...
                <div>
                    <label for="email">@lang('animations.contactTime')</label>
            ...
            <input class="button submit button-orange" type="submit" value="@lang('animations.buttonSend')" />
        </form>
    </div>
</section>
<!-- SECTION FOUUUUURRR-->
...
<div class="section4 contain">
    <div class="sec4text">
        <h1 style="text-align: center !important;" class="h1-font">@lang('animations.sec3h2')</h1>
        <div class="sec4textP">
            <p style="margin-top: 50px; text-align: center; margin-left: 13px">@lang('animations.sec3p')</p>
        </div>
