...
<div class="section1 contain">
    ...
    <div class="section1-1">
        <h3 class="h1-font">
            Moodle<br> LMS Adaption
        </h3>

        <p  class="p-font">
            We use the leading open source learning management<br>
            system Moodle which offers fully customizable features to<br>
            create private websites with online courses<br>
        </p>

        <ul class="p-font bold">
            <li class="uls">Strong community which constantly finds new<br> solutions for different challanges</li>
            <li class="uls">Create your theme onlie with your company's<br> brand identity</li>
            <li class="uls">Strong reporting and tracking options</li>
            <li class="uls">Fully adaptable for different devices</li>
        </ul>
    </div>

    <div class="secOneImg">
        <img src="{{'/images/online-courses.svg'}}">
    </div>
</div>
