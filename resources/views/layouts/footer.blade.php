<style>
    ...
    footer {
        ...
        color: white;
        background:url("{{asset('/images/footer/footer-dark.svg')}}");
    ...
    <div class="contain">
        <div class="footer-top-row">
            ...
            <div class="footer-top-column phone --center">
                <div>
                    <img src="{{asset('/images/footer/social-icons/phone-receiver.svg')}}" />
                ...
                <div>
                    <img src="{{asset('/images/footer/social-icons/mail.svg')}}" />
                    <p>
            ...
            <div class="footer-top-column --center nowrap">
                <img src="{{asset('/images/footer/social-icons/location.svg ')}}" />
                <address>
        ...
        <div class="footer-bot-row">
            <div class="footer-bot-column --left ">
                <a href="#"><img src="{{asset('/images/footer/social-icons/smartlab-white.svg')}}" class="footer-bot-icons" /></a>
            ...
            <div class="footer-bot-column --right">
                <div class="social-icons-container">
                    <a href="https://www.facebook.com/smartlabsarajevo/" target="_blank"><img src="{{asset('/images/footer/social-icons/fb-icon.svg')}}" class="footer-bot-icons" /></a>
                    <a href="https://www.linkedin.com/company/smartlab-sarajevo" target="_blank"><img src="{{asset('/images/footer/social-icons/linkedin-icon.svg')}}" class=" footer-bot-icons" /></a>
                    <a href="#" target="_blank">
                        <img src="{{asset('/images/footer/social-icons/skype-icon.svg')}}" class="footer-bot-icons" />
                    </a>
                    <a href="#" target="_blank">
                        <img src="{{asset('/images/footer/social-icons/youtube-icon.svg')}}" class="footer-bot-icons no-right-margin" />
                    </a>
                </div>
            </div>
        </div>
